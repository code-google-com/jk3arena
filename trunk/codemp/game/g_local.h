...
#define	GAMEVERSION	"Arena (pre-release)"
...
typedef struct {
	...
	int			todays_kills;
	int			todays_deaths;
	int			todays_experience;
	int			todays_captures;
	int			todays_returns;
	int			todays_duel_losses;
	int			todays_duel_wins;
	int			todays_objectives;
	char		username[1024];
	char		password[1024];
	char		rank[1024];
	char		myip[1024];
...
extern	vmCvar_t	sv_rconPassword;
...
//Arena: My cvars
extern	vmCvar_t	am_email;
extern	vmCvar_t	rconSE_password;
extern	vmCvar_t	am_sqlpass;
